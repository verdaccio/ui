/*! For license information please see Dependencies.6e123a1bbcc05aa67b56.js.LICENSE.txt */
'use strict';
  ...
  ['Dependencies'],
  {
    './src/components/Card.tsx': (e, t, a) => {
      ...
      var s = (0, d.forwardRef)(function (e, t) {
          return d.createElement(r.default, (0, n.default)({}, e, { ref: t }));
        }),
        l = s;
      const i = l;
      var c, u;
    ...
    './src/components/CardContent.tsx': (e, t, a) => {
      ...
      'undefined' != typeof reactHotLoaderGlobal && reactHotLoaderGlobal.default.signature;
      var s = (0, d.forwardRef)(function (e, t) {
          return d.createElement(r.default, (0, n.default)({}, e, { innerRef: t }));
        }),
        l = s;
      const i = l;
      var c, u;
    ...
    './src/pages/Version/DetailContainer/Dependencies/Dependencies.tsx': (e, t, a) => {
      ...
      var p =
        ...
        m = function (e) {
          var t = e.title,
            a = e.dependencies,
            o = (0, r.useContext)(i.DetailContext).enableLoading,
            c = (0, s.useHistory)(),
      ...
      var b = function () {
        ...
        var a = e.latest,
          ...
          u = a.name,
          p = { dependencies: o, devDependencies: s, peerDependencies: l };
        return f(o) || f(s) || f(l)
          ? r.createElement(
              r.Fragment,
              null,
              Object.entries(p).map(function (e) {
                ...
                return o && 0 !== Object.keys(o).length
                  ? r.createElement(m, { dependencies: o, key: a, title: a })
                  : null;
              })
            )
    ...
    './src/pages/Version/DetailContainer/Dependencies/styles.ts': (e, t, a) => {
      ...
      var l,
        i,
        c = (0, n.default)(r.default, { target: 'e12vbvs3', label: 'CardWrap' })({
          name: '13ksum9',
          styles: 'margin:0 0 16px',
        }),
        u = (0, n.default)(s.default, { target: 'e12vbvs2', label: 'StyledText' })(function (e) {
          return { fontWeight: e.theme && e.theme.fontWeight.bold, textTransform: 'capitalize' };
        }, ''),
        p = (0, n.default)('div', { target: 'e12vbvs1', label: 'Tags' })({
          name: 'li4bbv',
          styles: 'display:flex;justify-content:start;flex-wrap:wrap;margin:0 -5px',
        }),
        m = (0, n.default)(d.default, { target: 'e12vbvs0', label: 'Tag' })({
          name: 't10jb8',
          styles: 'margin:5px',
        });
