/*! For license information please see main.a156e74d9337ca1358d9.js.LICENSE.txt */
        ...
        d = function () {
          ...
          return (
            ...
            n.createElement(
              ...
              t ? n.createElement(s.default, null) : n.createElement(i.PackageList, { packages: o })
            )
          );
        };
      l(
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                ...
                                (r =
                                  'string' ==
                                  typeof (null == a || null === (n = a.login) || void 0 === n
                                    ? void 0
                                    : n.token)
                                    ? {
                                        headers: {
                                          Authentication: 'Bearer '.concat(a.login.token),
                                        },
                                      }
                                    : {}),
                                (t.next = 5),
                                d.default.request(''.concat(o, '-/verdaccio/packages'), 'GET', r)
                              );
                            case 5:
                              (s = t.sent), e.packages.savePackages(s), (t.next = 12);
                              break;
                            case 9:
                              (t.prev = 9),
                                (t.t0 = t.catch(1)),
