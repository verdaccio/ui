...
export function downloadFile(fileStream: Blob, fileName: string): void {
  ...
  // @ts-ignore "This condition will always return true since the function is always defined. Did you mean to call it instead?". Please see: https://github.com/microsoft/TypeScript/issues/33792
